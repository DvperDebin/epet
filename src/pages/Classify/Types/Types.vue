<template>
  ...
  <div class="classify_main">
    ...
    <!-- 主体内容展现 -->
    <div class="classify_main_content_wrapper">
      <div class="classify_main_content_inner">
          ...
          <div class="classify_main_content_type1">
            ...
            <div class="classify_main_img" >
              <div v-for="(info,index) in type.cate_list[0].list" :key="index">
                <a href="###">
                  <img v-lazy="info.photo ||info.logo">
                </a>
                <span>{{info.name}}</span>
              </div>
            </div>
  ...
  export default {
    ...
    mounted(){
      ...
      this.$store.dispatch('getCategorys', () => {
        this.$nextTick( () => {
          new BScroll('.classify_main_types',{
            click:true,
            scrollY:true
          })
          new BScroll('.classify_main_content_wrapper',{
            click:true,
            scrollY:true
          })
        })
